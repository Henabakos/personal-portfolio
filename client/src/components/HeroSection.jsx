...
const HeroSection = () => {
  return (
    <div>
      <div className="w-full h-[70vh] flex sm:max-md:h-screen flex-col md:flex-row items-center justify-center md:gap-4  lg:h-screen px-4 md:px-8 lg:pl-12 xl:pl-16 py-10">
        <div className="w-full lg:text-left">
          ...
          <div className="mb-8">
            <p className="text-sm sm:text-base md:text-lg font-regular text-gray-700 leading-relaxed">
        ...
        <div className="flex items-center justify-center w-full md:w-1/2 mx-auto mt-10 lg:mt-0">
          <img
